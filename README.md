...
> The extension will only work on [linkedin.com](www.linkedin.com) and only extract viable information from [linkedin.com/in/{profileurl}](www.linkedin.com/in/feed) pages. You will also need to login first.  
